...
if __name__ == "__main__":
    ...
    def run(n_obs=args.n_obs, run_type=args.run):
        ...
        if "train" in run_type:
            ...
            scores_data = lc2st.get_scores_on_observed_data(theta_o=samples_obs, x_o=x_obs.reshape(-1))
            results_dict = {"scores_data": scores_data}
            ...
            if "null" in run_type:
                ...
                p_value = lc2st.p_value(theta_o=samples_obs, x_o=x_obs.reshape(-1), verbosity=1)
            ...
            for key, value in results_dict.items():
                print()
                print(f"{key}: {value}")
            print(results_dict["scores_data"].mean(), results_dict["scores_data"].std())
            print()
